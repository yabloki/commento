...
var errorAlreadyVoted = errors.New("You cannot change your vote.")
var errorNoLikes = errors.New("No available likes.")
var errorNoMessages = errors.New("No available comments.")
